...
const ContactInfo = (props: any) => {
  ...
  return (
    <div className={styles.contactBox}>
      ...
      <p className={styles.title} style={{ color: "#4D817D" }}>
        {props.name}
      </p>
      {role == "PRO" && (
        <p
      ...
      >
        ...
        >
          Créer un groupe avec {props.name.slice(0, props.name.indexOf(" "))}
        </p>
      </div>
      <Stack
        direction="row"
      ...
      >
        <Button
          onClick={() => {
            deleteChat(props.room);
          }}
          style={{ width: "90%", fontSize: "15px" }}
          variant="outlined"
          startIcon={<DeleteOutlineOutlinedIcon style={{ fontSize: "30px" }} />}
        >
